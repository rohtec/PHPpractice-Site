	...
	<section>
		...
		<article class="second">
            <div class="left">
				...
				<h5>$29<span> per month</span></h5>
				<h4>Full access for less than $1 a day</h4>
				<button><a href="./signin.php">Log in</a></button>
				<p class="create">New to Rotec  Libraries? <a href="./signup.php"><u>Create a free account</u></a></p>
            </div>
            <div class="right">
            	<h3>Why Us</h3>
            	<h6>Tutorials by industry experts<br>
            		Peer & expert code review<br>
            		Coding exercises<br>
            		Access to our GitHub repos<br>
            		Community forum<br>
            		Flashcard decks<br>
            	New videos every week</h6>
            </div>
        </article>
	</main>
	</section>
